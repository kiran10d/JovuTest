...
@InputType()
class AppointmentCreateNestedManyWithoutStaffItemsInput {
...
export { AppointmentCreateNestedManyWithoutStaffItemsInput as AppointmentCreateNestedManyWithoutStaffItemsInput };
